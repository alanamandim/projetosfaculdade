...
public class BaseBiBliografica {



    private ArrayList<EntradadeDados> entradadeDados;
    ...
    public void adicionaMasterthesis(String nome, String autor, String title, String year){
        ...
        entradadeDados.add(masterthesis);
    }
    ...
    public void adicionaTechreport(String nome,String author, String institution, String title, String year){
        ...
        entradadeDados.add(techreport);

    }

    public ArrayList<EntradadeDados> getEntradadeDados() {
        return entradadeDados;
    }

    public void adicionaMes(int i,String month){
        entradadeDados.get(i).setMonth(month);
    }
    ...
    public void adicionaVolume(int i, String volume){
        entradadeDados.get(i).setVolume(volume);
    }
    public void removeVolume(int i){entradadeDados.get(i).setVolume(null);}

    public void adicionaAdress(int i, String adress){
        entradadeDados.get(i).setAdress(adress);
    }
    public void removeAdress(int i){entradadeDados.get(i).setAdress(null);}

    public void adicionaAuthor(int i, String author){entradadeDados.get(i).setAuthor(author);}
